...
# Fonction pour lire le fichier GTF en ignorant les lignes mal formées
def read_gtf(filepath):
    try:
        # Modification ici: utilisation de `on_bad_lines='skip'` pour ignorer les lignes mal formées
        ...
        raise Exception(f"Erreur d'analyse du GTF : {e}")
